...
public class Flight {
    ...
    public String toString() {
        return "Flight{" + "id=" + id + ", flightnr=" + flightnr + ", departureDate=" + departureDate + ", departureTime=" + departureTime + ", arrivalDate=" + arrivalDate + ", arrivalTime=" + arrivalTime + ", airline=" + airline + ", origin=" + origin + ", destination=" + destination + ", airplane=" + airplane + '}';
    }
