...
public class CustomerServiceProxy implements ICustomerService{
    ...
    private static final String customersURL="http://localhost:8080/rst1-service/rest/customers";
     private static final String customerURL="http://localhost:8080/rst1-service/rest/customer/{customerNumber}";
